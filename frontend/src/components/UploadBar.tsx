...
import { uploadFile, uploadProject, generateProjectSummary, visualizeProject } from '../services/api'
...
export default function UploadBar() {
  ...
  const handleVisualize = useCallback(async () => {
    ...
    try {
      const data = await visualizeProject()
      updateResponseContent(id, JSON.stringify(data))
      setResponseDone(id)
    } catch (err: unknown) {
